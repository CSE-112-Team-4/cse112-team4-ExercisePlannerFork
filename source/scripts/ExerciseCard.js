...
class ExerciseCard extends HTMLElement {
  ...
  activateEditFunction(
    ...
    submitButton.addEventListener("click", function () {
      ...
      data = {
        // clone found here, please try to find a better way to do this, e.g. by using fuctions or variables
      ...
      header
        .getElementsByClassName("type-input")[0]
        .setAttribute(
          "value",
          header.getElementsByClassName("type-input")[0].value,
        );
